      ...
      <div className="flex-1">
        ...
        <div className="bg-white shadow-sm border-b border-gray-200 p-6">
          <div className="ml-16 lg:ml-0">
            <h1 className="text-2xl font-bold text-gray-800">CO-PO Mapping</h1>
                ...
                <table className="min-w-full border border-gray-300">
                  <thead>
                    <tr className="bg-gray-50">
                      <th className="border border-gray-300 px-4 py-3 text-left text-sm font-medium text-gray-700 sticky left-0 bg-gray-50">
                        CO / PO
                      </th>
                  ...
                  <tbody>
                    {courseOutcomes.map(co => (
                      <tr key={co} className="hover:bg-gray-50">
                        <td className="border border-gray-300 px-4 py-3 font-medium text-gray-800 bg-gray-50 sticky left-0">
                          {co}
                        </td>
                        {programOutcomes.map(po => (
